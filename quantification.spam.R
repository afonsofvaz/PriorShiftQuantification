...
require(plyr)
require(dplyr)
source(file="../Codes/g.functions1.R")
...
for(i in 2:nrow(samples)){
  ...
  gc()
  save(experiment.real,file="../Outputs/Spam/experiment.real_all.RData")
  save(experiment.estimative,file="../Outputs/Spam/experiment.estimative_all.RData")
}
