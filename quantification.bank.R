...
load("..\\Data\\bank.data.RData")
load("..\\Data\\bank.samples.RData")
...
save(experiment.real,file="..\\Outputs\\Bank\\experiment.estimative.correct.RData")
save(experiment.estimative,file="..\\Outputs\\Bank\\experiment.real.correct.RData")
}
